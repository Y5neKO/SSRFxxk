...
import com.y5neko.burpext.utils.JSONUtils;
import com.y5neko.burpext.utils.RuleMatcherUtils;
...
public class KeywordsDetect {
    ...
    public KeywordsDetect(HttpRequestToBeSent httpRequestToBeSent, Detector detector, boolean isKeywordsDetect, Logging logging) {
        try {
            ...
            // 获取请求参数关键字和规则
            JSONArray parametersRules = config.getJSONArray("params");
            // 获取响应关键字和规则
